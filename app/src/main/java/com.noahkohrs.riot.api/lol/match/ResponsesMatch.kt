...
public class Participant private constructor(
    ...
    public class UserData(
        ...
        @JvmField public val puuid: String, //moi them
        @JvmField public val summonerId: String, //moi them
    )
    ...
    public class PlayerStats(
        ...
        @JvmField public val lane: String, //moi them
    )
            ...
            return Participant(
                ...
                userData =
                    UserData(
                        ...
                        puuid = dto.puuid, //moi them
                        summonerId = dto.summonerId //moi them
                    ),
                pings =
                    PingsStats(
